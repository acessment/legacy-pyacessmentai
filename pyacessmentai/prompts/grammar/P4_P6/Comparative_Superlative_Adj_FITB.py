...
Comparative_Superlative_Adj_FITB: BasicPrompts = BasicPrompts(
...
Comparative_Superlative_Adj_FITB.add_chain(
...
Comparative_Superlative_Adj_FITB.add_json_chain(JSONPrompt.ONE_BY_ONE_FITB)
